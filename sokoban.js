...
var ASM_CONSTS = {
  90488: () => { if (document.fullscreenElement) return 1; },  
 90534: () => { return document.getElementById('canvas').width; },  
 90586: () => { return parseInt(document.getElementById('canvas').style.width); },  
 90654: () => { document.exitFullscreen(); },  
 90681: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 90754: () => { if (document.fullscreenElement) return 1; },  
 90800: () => { return document.getElementById('canvas').width; },  
 90852: () => { return screen.width; },  
 90877: () => { document.exitFullscreen(); },  
 90904: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 91037: () => { if (document.fullscreenElement) return 1; },  
 91083: () => { return document.getElementById('canvas').width; },  
 91135: () => { return parseInt(document.getElementById('canvas').style.width); },  
 91203: () => { if (document.fullscreenElement) return 1; },  
 91249: () => { return document.getElementById('canvas').width; },  
 91301: () => { return screen.width; },  
 91326: () => { if (document.fullscreenElement) return 1; },  
 91372: () => { return document.getElementById('canvas').width; },  
 91424: () => { return screen.width; },  
 91449: () => { document.exitFullscreen(); },  
 91476: () => { if (document.fullscreenElement) return 1; },  
 91522: () => { return document.getElementById('canvas').width; },  
 91574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 91642: () => { document.exitFullscreen(); },  
 91669: () => { return screen.width; },  
 91694: () => { return screen.height; },  
 91720: () => { return window.screenX; },  
 91747: () => { return window.screenY; },  
 91774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91827: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 91898: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 91955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 92026: () => { if (document.fullscreenElement) return 1; },  
 92072: () => { if (document.pointerLockElement) return 1; }
};
